...
/**
  ...
  */
/* PendSV_Handler is provided by ThreadX (tx_initialize_low_level.S / tx_thread_schedule.S). */

/* SysTick_Handler is provided by ThreadX (tx_initialize_low_level.S):
   ThreadX owns SysTick as its time base, HAL uses TIM6 instead
   (see stm32h7rsxx_hal_timebase_tim.c). */
