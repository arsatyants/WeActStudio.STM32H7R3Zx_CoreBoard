...
UX_SLAVE_ENDPOINT                       *endpoint;
    ...
    printf("CDC-ECM _change: itf=%u altsetting=%u\r\n",
           interface_ptr->ux_slave_interface_descriptor.bInterfaceNumber,
           interface_ptr->ux_slave_interface_descriptor.bAlternateSetting);

    extern volatile ULONG dbg_counters[30];
    dbg_counters[3]++;
    dbg_counters[4] = interface_ptr->ux_slave_interface_descriptor.bInterfaceNumber;
    dbg_counters[5] = interface_ptr->ux_slave_interface_descriptor.bAlternateSetting;
